...
export const css_mode_ea_button = css`
  .ea-button {
    appearance: none;
    align-items: center;
    background: var(--ea-background, var(--ea-button-background));
    border: var(--ea-border, var(--ea-button-border, 0.1em solid var(--ea-color-1-dark)));
    border-radius: var(--ea-border-radius, var(--ea-button-border-radius, 0.1em));
  ...
  .ea-button[primary] {
    ...
    border: var(--ea-border, var(--ea-button-border, 0.1em solid var(--ea-color-1a)));
  }

  .ea-button[primary]:hover:not(:active) {
    background: var(--ea-background, var(--ea-button-background, var(--ea-color-1a)));
  }
  ...
  .ea-button[active],
  .ea-button.active {
    background: var(--ea-background, var(--ea-button-background, var(--ea-color-1b)));
    text-decoration: none;
  }
  ...
  .ea-button:hover:not(:active) {
    background: var(--ea-background, var(--ea-button-background, var(--ea-color-1-light)));
  }
...
`
export const css_mode_ea_card = css`
  .ea-card {
    font-size: calc(var(--ea-sizer) * 1rem);
    background: var(--ea-background, var(--ea-card-background, var(--ea-background-1)));
  ...
  .ea-card .ea-card-header {
    border-bottom: var(--ea-border, var(--ea-card-header-border, var(--ea-border-1)));
  ...
  .ea-card .ea-card-footer {
    ...
    background: transparent;
    border-top: var(--ea-border, var(--ea-card-footer-border, var(--ea-border-1)));
    padding: calc(var(--ea-spacer) * 1em);
  }
...
`
export const css_mode_ea_fonts = css`
  @font-face {
...
`
export const css_mode_ea_layout = css`
  :host(ea-layout),
  .ea-layout {
    font-size: calc(var(--ea-sizer) * 1rem);
    display: grid;
  ...
  .ea-toolbar {
    ...
    height: calc(var(--ea-spacer) * var(--ea-sizer) * var(--ea-toolbar-height, 100%));
    padding: var(--ea-padding, var(--ea-toolbar-padding));
    background: var(--ea-background, var(--ea-toolbar-background, var(--ea-background-1)));
    display: flex;
    align-items: center;
  }
  .ea-toolbar[border] {
  ...
  .ea-drawer {
    ...
    background: var(--ea-background, var(--ea-drawer-background, var(--ea-background-1)));
  ...
  .ea-main {
    overflow: auto;
    background: var(--ea-background, var(--ea-main-background, var(--ea-background-2)));
  }
  .ea-body {
    display: flex;
    flex-direction: column;
  ...
  .ea-footer {
    background: var(--ea-background, var(--ea-footer-background, var(--ea-background-1)));
    width: var(--ea-footer-width, 100%);
    padding: var(--ea-padding, var(--ea-footer-padding));
  }
`
export const css_mode_ea_link = css`
  .ea-link {
...
export const css_mode_ea_nav = css`
  .ea-nav ul {
    display: flex;
  ...
  .ea-nav.nav-pills li:hover {
    background: var(
      --ea-background-hover,
      var(--ea-nav-background-hover, var(--ea-color-1-light, var(--ea-color-grey-light)))
    );
  }
  .ea-nav.nav-pills li:active,
  .ea-nav.nav-pills li[active],
  .ea-nav.nav-pills li.active {
    background: var(--ea-background-active, var(--ea-nav-background-active, var(--ea-color-1)));
    font-weight: 500;
  }
`
...
export const css_mode_ea_variables = css`
  .mode {
    /* Base Colors */
